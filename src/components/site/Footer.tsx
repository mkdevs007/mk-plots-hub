      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            {[
              { Icon: InstagramIcon, label: "Instagram", href: "https://www.instagram.com/mk_builders_developers?igsh=emRtNnhsZnRkdzdh" },
              ...
              <a
                key={label}
                href={href}
                target={label === "WhatsApp" || href.startsWith("http") ? "_blank" : undefined}
                rel="noreferrer"
                aria-label={label}
