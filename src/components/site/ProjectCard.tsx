        ...
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <div className="absolute inset-0 bg-primary/60 backdrop-blur-xs opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center gap-3 p-4 z-10">
            <Link
              ...
              params={{ slug: p.slug }}
              hash="layout-map"
              className="px-5 py-2.5 rounded-md gold-gradient text-gold-foreground font-semibold text-xs tracking-wider uppercase shadow-md transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 cursor-pointer"
            >
              View Layout Map
            </Link>
            <Link
              ...
              params={{ slug: p.slug }}
              hash="enquiry"
              className="px-5 py-2.5 rounded-md bg-white/10 hover:bg-white/20 text-white font-semibold text-xs tracking-wider uppercase border border-white/20 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75 cursor-pointer"
            >
              Enquire Now
            </Link>
          </div>
      ...
      <div className="px-6 pb-6 mt-auto">
        <div className="flex gap-2">
          ...
          <Link
            ...
            params={{ slug: p.slug }}
            hash="enquiry"
            className="flex-1 text-center px-4 py-2.5 rounded-md gold-gradient text-gold-foreground text-sm font-semibold hover:opacity-90 transition cursor-pointer"
          >
            Enquire
          </Link>
        </div>
