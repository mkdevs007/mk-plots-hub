    ...
    <SiteLayout>
        ...
        <div className="relative z-10 max-w-7xl mx-auto h-full flex flex-col justify-between pt-28 md:pt-36 pb-12 px-5 md:px-8">
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <a
                href={`https://wa.me/919999999999?text=${encodeURIComponent(`Hi, I'm interested in ${p.name} (${p.area}, ${p.city}). Please share pricing and availability.${utmNote}`)}`}
                target="_blank"
                rel="noreferrer"
        ...
        <section className="py-20 md:py-28 px-5 md:px-8 plum-gradient relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`https://wa.me/919999999999?text=${encodeURIComponent(`Hi, I'm interested in ${p.name} (${p.area}, ${p.city}). Please share details.${utmNote}`)}`}
                target="_blank"
                rel="noreferrer"
      ...
      {p.status !== "Completed" && (
        <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-white border-t border-border px-4 py-3 flex gap-3 safe-bottom shadow-[0_-4px_20px_rgba(81,37,97,0.12)]">
          ...
          <a
            href={`https://wa.me/919999999999?text=${encodeURIComponent(`Hi, I'm interested in ${p.name} at ${p.area}, ${p.city}. Please share pricing.${utmNote}`)}`}
            target="_blank"
            rel="noreferrer"
